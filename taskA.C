...
*/
    ...
    // GRAFICI DI ETA
    TH1D *truepionEta = new TH1D("truepionEta","Eta of positive Pions;Eta",80,-3.5,3.5);
    TH1D *RecpionEta = new TH1D("RecpionEta","Eta of reconstructed Pions+;Eta",80,-3.5,3.5);
    TH1D *truekaonEta = new TH1D("truekaonEta","Eta of positive Kaons;Eta",80,-3.5,3.5);
    TH1D *ReckaonEta = new TH1D("ReckaonEta","Eta of reconstructed K+;Eta",80,-3.5,3.5);
    TH1D *trueprotonEta = new TH1D("trueprotonEta","Eta of positive Protons;Eta",80,-3.5,3.5);
    TH1D *RecprotonEta = new TH1D("RecprotonEta","Eta of reconstructed Protons;Eta",80,-3.5,3.5);
    // GRAFICI DI PHI
    TH1D *truepionPhi = new TH1D("truepionPhi","Phi of positive Pions; Phi",80,0,180);
    TH1D *RecpionPhi = new TH1D("RecpionPhi","Phi of reconstructed Pions+; Phi",80,0,180);    
    TH1D *truekaonPhi = new TH1D("truekaonPhi","Phi of positive Kaons; Phi",80,0,180);
    TH1D *ReckaonPhi = new TH1D("ReckaonPhi","Phi of reconstructed Kaons+; Phi",80,0,180);  
    TH1D *trueprotonPhi = new TH1D("trueprotonPhi","Phi of positive Protons; Phi",80,0,180);
    ...
    truepionQ2->Scale(1.0 / (14*total11));
    truekaonQ2->Scale(1.0 / (14*total11));
    trueprotonQ2->Scale(1.0 / (14*total11));
    /*
    ...
    truepionQ2->SetTitle("MC Production of positive particles | 18x275 GeV");
    ...
    //trueQ2->SetTitle("Production of positive particles with Q2");
    trueQ2->Update();
    trueQ2->Write();
    ...
    RecpionQ2->Scale(1.0 / (14*total12));
    ReckaonQ2->Scale(1.0 / (14*total12));
    RecprotonQ2->Scale(1.0 / (14*total12));
    /*
    // Normalize each bin across all histograms
    for (int i = 1; i <= nBins; ++i) {
    ...
    RecpionQ2->SetTitle("Reconstruction of positive particles | 18x275 GeV");
    ...
    Sinpione_Q2->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
    ...
    truepion_xbj->Scale(1.0 / (14*total21));
    truekaon_xbj->Scale(1.0 / (14*total21));
    trueproton_xbj->Scale(1.0 / (14*total21));
    /*
    // Normalize each bin across all histograms
    for (int i = 1; i <= nBins; ++i) {
    ...
    truepion_xbj->SetTitle("MC Production of positive particles | 18x275 GeV");
    ...
    Recpion_xbj->Scale(1.0 / (14*total22));
    Reckaon_xbj->Scale(1.0 / (14*total22));
    Recproton_xbj->Scale(1.0 / (14*total22));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    Recpion_xbj->SetTitle("Reconstruction of positive particles| 18x275 GeV");
    ...
    Sinpione_xbj->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
    ...
    truepion_z->Scale(1.0 / (14*total31));
    truekaon_z->Scale(1.0 / (14*total31));
    trueproton_z->Scale(1.0 / (14*total31));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    */
    ...
    truepion_z->SetTitle("MC Production of positive particles | 18x275 GeV");
    ...
    Recpion_z->Scale(1.0 / (14*total32));
    Reckaon_z->Scale(1.0 / (14*total32));
    Recproton_z->Scale(1.0 / (14*total32));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    */
    ...
    Recpion_z->SetTitle("Reconstruction of positive particles | 18x275 GeV");
    ...
    Sinpione_z->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
    ...
    truepion_PhT->Scale(1.0 / (14*total41));
    truekaon_PhT->Scale(1.0 / (14*total41));
    trueproton_PhT->Scale(1.0 / (14*total41));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    */
    ...
    truepion_PhT->SetTitle("MC Production of positive particles | 18x275 GeV");
    ...
    Recpion_PhT->Scale(1.0 / (14*total42));
    Reckaon_PhT->Scale(1.0 / (14*total42));
    Recproton_PhT->Scale(1.0 / (14*total42));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    */
    ...
    Recpion_PhT->SetTitle("Recontruction of positive particles | 18x275 GeV");
    ...
    Sinpione_PhT->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
    ...
    truepionEta->Scale(1.0 / (14*total51));
    truekaonEta->Scale(1.0 / (14*total51));
    trueprotonEta->Scale(1.0 / (14*total51));
     /*for (int i = 1; i <= nBins; ++i) {
    ...
    truepionEta->SetTitle("MC Production of positive particles | 18x275 GeV");
    ...
    RecpionEta->Scale(1.0 / (14*total52));
    ReckaonEta->Scale(1.0 / (14*total52));
    RecprotonEta->Scale(1.0 / (14*total52));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    RecpionEta->SetTitle("Reconstruction of positive particles | 18x275 GeV");
    ...
    Sinpione_Eta->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
    ...
    truepionPhi->Scale(1.0 / (14*total61));
    truekaonPhi->Scale(1.0 / (14*total61));
    trueprotonPhi->Scale(1.0 / (14*total61));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    truepionPhi->SetTitle("MC Production of positive particles | 18x275 GeV");
    ...
    RecpionPhi->Scale(1.0 / (14*total62));
    ReckaonPhi->Scale(1.0 / (14*total62));
    RecprotonPhi->Scale(1.0 / (14*total62));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    RecpionPhi->SetTitle("Reconstruction of positive particles | 18x275 GeV");
    ...
    Sinpione_Phi->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
    ...
    TCanvas *true_Mom = new TCanvas("True_Mom", "Production of positive particles with the Momentum", 800, 600);
    true_Mom->SetLogx();
    ...
    truepion_mom->Scale(1.0 / (14*total71));
    truekaon_mom->Scale(1.0 / (14*total71));
    trueproton_mom->Scale(1.0 / (14*total71));
   /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    truepion_mom->SetTitle("MC production of positive particles | 18x275");
    ...
    TCanvas *Rec_Mom = new TCanvas("Rec_Mom", "Production of positive particles with the Momentum", 800, 600);
    Rec_Mom->SetLogx();
    ...
    Recpion_mom->Scale(1.0 / (14*total72));
    Reckaon_mom->Scale(1.0 / (14*total72));
    Recproton_mom->Scale(1.0 / (14*total72));
    /*
    for (int i = 1; i <= nBins; ++i) {
    ...
    */
    ...
    Recpion_mom->SetTitle("Reconstruction of positive particles | 18x275");
    ...
    Sinpione_mom->SetTitle("Efficiency reconstruction of positive particles | 18x275 GeV");
...
int main11() {
  ...
  const char* outputFile = "out11.hist.root";
...
int main12() {
  ...
  const char* outputFile = "out12.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main13() {
  ...
  const char* outputFile = "out13.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main14() {
  ...
  const char* outputFile = "out14.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main15() {
  ...
  const char* outputFile = "out15.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main16() {
  ...
  const char* outputFile = "out16.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main17() {
  ...
  const char* outputFile = "out17.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main18() {
  ...
  const char* outputFile = "out18.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main19() {
  ...
  const char* outputFile = "out19.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main20() {
  ...
  const char* outputFile = "out20.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main21() {
  ...
  const char* outputFile = "out21.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main22() {
  ...
  const char* outputFile = "out22.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main23() {
  ...
  const char* outputFile = "out23.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main24() {
  ...
  const char* outputFile = "out24.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main25() {
  ...
  const char* outputFile = "out25.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main26() {
  ...
  const char* outputFile = "out26.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main27() {
  ...
  const char* outputFile = "out27.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main28() {
  ...
  const char* outputFile = "out28.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main29() {
  ...
  const char* outputFile = "out29.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main30() {
  ...
  const char* outputFile = "out30.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main31() {
  ...
  const char* outputFile = "out31.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main32() {
  ...
  const char* outputFile = "out32.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
...
int main33() {
  ...
  const char* outputFile = "out33.hist.root";
  pino(inputFile1, inputFile2, inputFile3, outputFile);
