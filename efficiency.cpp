...
int gatto() {
    const char* combinedFileName = "combined.hist2.root";
    ...
    */
    ...
    TFile *outputFile = TFile::Open("ratio_canvas2.root", "RECREATE");
    ...
    fpion11->SetTitle("MC Production of positive particles | Q^2 | 18x275 GeV");
    ...
    //MCfraction_Q2->SetTitle("Production of positive particles with Q2");
    ...
    fpion12->SetTitle("Reconstructed production of positive particles | Q^2 | 18x275 GeV");
    ...
    //RecFraction_Q2->SetTitle("Production of positive particles with Q2");
    ...
    kaon_xbj_ID->GetXaxis()->SetTitle("z");
    ...
    fpion21->SetTitle("MC Production of positive particles | x_B | 18x275 GeV");
    ...
    //MCfraction_xbj->SetTitle("Production of positive particles with Q2");
    ...
    fpion22->SetTitle("Reconstructed production of positive particles | x_B | 18x275 GeV");
    ...
    //RecFraction_xbj->SetTitle("Production of positive particles with Q2");
    ...
    fpion31->SetTitle("MC Production of positive particles | z | 18x275 GeV");
    ...
    //MCfraction_z->SetTitle("Production of positive particles with Q2");
    MCfraction_z->Update();
    MCfraction_z->Write();
    ...
    fpion32->SetTitle("Reconstructed production of positive particles | z | 18x275 GeV");
    ...
    //RecFraction_z->SetTitle("Production of positive particles with Q2");
    ...
    fpion41->SetTitle("MC Production of positive particles | P_hT | 18x275 GeV");
    ...
    //MCfraction_PhT->SetTitle("Production of positive particles with Q2");
    ...
    fpion42->SetTitle("Reconstructed production of positive particles | P_hT | 18x275 GeV");
    ...
    //RecFraction_PhT->SetTitle("Production of positive particles with Q2");
    ...
    fpion51->SetTitle("MC Production of positive particles | Eta | 18x275 GeV");
    ...
    //MCfraction_Eta->SetTitle("Production of positive particles with Q2");
    ...
    fpion52->SetTitle("Reconstructed production of positive particles | Eta | 18x275 GeV");
    ...
    //RecFraction_Eta->SetTitle("Production of positive particles with Q2");
    ...
    fpion61->SetTitle("MC Production of positive particles | Phi | 18x275 GeV");
    ...
    //MCfraction_Phi->SetTitle("Production of positive particles with Q2");
    ...
    fpion62->SetTitle("Reconstructed production of positive particles | Phi | 18x275 GeV");
    ...
    //RecFraction_Phi->SetTitle("Production of positive particles with Q2");
    ...
    fpion71->SetTitle("MC Production of positive particles | P_h | 18x275 GeV");
    ...
    //MCfraction_Mom->SetTitle("Production of positive particles with Q2");
    ...
    fpion72->SetTitle("Reconstructed production of positive particles | P_h | 18x275 GeV");
    ...
    //RecFraction_Mom->SetTitle("Production of positive particles with Q2");
