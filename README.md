...
FILE NAME:
- "pythia_ep_noradcor_18x275_eic.txt":   Pythia6.4 event generation of electron-proton collisions, the energy beam for the electron is set at 18 GeV while the proton one at 275 GeV. This program was created by the Software & Computing group in the ePIC Campaign1.0.0 some months ago, so it IS NOT MINE, there are just a few corrections but nothing valuable. More from the public repository of https://gitlab.com/eic/mceg/PYTHIA-RAD-CORR.git and the ePIC instructions https://eic.github.io/software/pythia6.html
